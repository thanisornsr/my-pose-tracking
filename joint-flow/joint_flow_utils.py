...
def joint_flow_pipeline_first_frame(model,input_pose_id,input_img):
...
# ---------------------------------------------------------------------------------------------------------------------------
def joint_flow_pipeline(model,input_pose_id,input_img0,input_img1,input_poses0):
	prediction = model([input_img0,input_img1])

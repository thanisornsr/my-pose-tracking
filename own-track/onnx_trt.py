...
if USE_FP16:
    os.system("/usr/src/tensorrt/bin/trtexec --onnx=FS_onnx_model.onnx --saveEngine=FS_engine.trt --explicitBatch --fp16")
else:
    os.system("/usr/src/tensorrt/bin/trtexec --onnx=FS_onnx_model.onnx --saveEngine=FS_engine.trt --explicitBatch")
